...
constexpr int activatedL2size = 2 * L2size;
constexpr int L3size = 8;
constexpr int activatedL3size = L3size;
...
constexpr int activatedL3Q = totalL3Q;
constexpr int outputQ = activatedL3Q * L4Q;
// clang-format off
